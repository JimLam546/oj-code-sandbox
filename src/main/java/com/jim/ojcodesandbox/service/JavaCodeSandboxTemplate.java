...
import com.jim.ojcodesandbox.model.ExecuteMessage;
import com.jim.ojcodesandbox.model.JudgeInfo;
import com.jim.ojcodesandbox.utils.ProcessUtils;
...
import static com.jim.ojcodesandbox.model.JudgeInfoMessageEnum.COMPILE_ERROR;
...
//        2. 编译代码，得到 class 文件
        ...
        if (compileFileExecuteMessage.getExitValue() == 1) {
            ...
            // 覆盖控制台编译错误的提示信息，将 message 的内容直接设置为编译错误
            ...
            outputResponse.setStatus(FAILURE);
